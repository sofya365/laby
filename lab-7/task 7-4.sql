...
DROP FUNCTION IF EXISTS CalculateChange $$
CREATE FUNCTION CalculateChange(facid INT, frac FLOAT, starttime TIMESTAMP, stoptime TIMESTAMP)
  RETURNS VARCHAR(50)
  READS SQL DATA
  NOT DETERMINISTIC
  BEGIN
...
SELECT CalculateChange(2, 5, '2012-07-01','2012-07-31 23:59:59')
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/CalculateChange.csv' 
FIELDS ENCLOSED BY '"' 
TERMINATED BY ';' 
ESCAPED BY '"' 
LINES TERMINATED BY '\n';